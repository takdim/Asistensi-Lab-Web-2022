...
<body>
   ...
   <img src="admin/img/logo_ut.png" width="100" />
    ...
    <div class="container">
        <div class="isi">
            <h2 style="text-align:center; text-transform:uppercase;">LAPORAN DATA HASIL TES MAPEL {{$data->first()->tes->mapel->mapel}} Periode {{carbon\carbon::parse($data->first()->tes->periode->tahun)->translatedFormat('Y')}}</h2>
            <br>            
