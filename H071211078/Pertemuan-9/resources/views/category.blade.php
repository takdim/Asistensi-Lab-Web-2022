...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#tambahDataCategory">
                                + Tambah Category
                            </button>
                        </li>
                    </ul>
    ...
    <div class="d-flex justify-content-center flex-column align-items-center mt-5">
        ...
        @if ($errors->any())
        <div class="alert alert-danger alert-dismissable fade show w-75" role="alert">
        ...
        <div class="alert alert-success alert-dismissable fade show w-75" role="alert">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-grid gap-2 d-md block">
                            ...
                            <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteCategoryUseQueryBuilder{{$item->id }}" type="button">Delete</button>
                        </div>
                    </td>
                </tr>
