    ...
    <div class="d-flex justify-content-center flex-column align-items-center mt-5">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-grid gap-2 d-md-block">
                            <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editS_PermUseQueryBuilder{{ $item->id }}" type="button">Edit</button>
                            <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteS_PermUseQueryBuilder{{ $item->id }}" type="button">Hapus</button>
                        </div>
                    </td>
                </tr>
                ...
                <div class="modal fade" id="deleteS_PermUseQueryBuilder{{ $item->id }}" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a type="button" class="btn btn-danger" href="deleteS_PermUseQueryBuilder/{{ $item->id }}">Hapus</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="editS_PermUseQueryBuilder{{ $item->id }}" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="editS_PermUseQueryBuilder/{{ $item->id }}" method="POST">
                                    @csrf
                                    <div class="mb-3 row">
    ...
    <div class="modal fade" id="tambahDataS_Permission" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="saveS_PermUseQueryBuilder" method="POST">
                        @csrf
                        <div class="mb-3 row">
                            <label for="inputPassword" class="col-sm-2 col-form-label">Seller</label>
                            <div class="col-sm-10">
