...
?>
    <h2 class="w3-container w3-2021-inkwell w3-center">Admin Dashboard</h2>
    <div class="w3-container">
        <p>Welcome <?php echo $_SESSION['username']; ?>,</p>
        <p><a href="new.php" class="w3-button w3-2021-inkwell">Create new post</a></p>
...
for ($i = ($page - $range); $i < ($page + $range) + 1; $i++) {
    if (($i > 0) && ($i <= $totalpages)) {
        if ($i == $page) {
            echo "<div class='w3-btn w3-2021-inkwell'> $i</div>";
        } else {
