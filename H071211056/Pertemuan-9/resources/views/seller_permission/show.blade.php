...
<div class="card">
  <div class="card-header">Halaman Perizinan Penjual</div>
  <div class="card-body">
  

        <div class="card-body">
        <p class="card-text">Seller_id : {{ $seller_permission->seller_id }}</p>
        <p class="card-text">Permission_id : {{ $seller_permission->permission_id }}</p>
  </div>
