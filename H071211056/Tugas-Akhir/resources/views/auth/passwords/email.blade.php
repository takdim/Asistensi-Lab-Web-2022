                    ...
                    <div class="row no-gutters">
                        <div class="col-xl-12">
                            <div class="auth-form">
                                ...
                                <p class="auth-subtitle mb-3">Masukkan emailmu, untuk mereset kembeli password.</p>
                                @if (session('message'))
                                ...
                                <form method="POST" action="/forget-password">
                                    ...
                                    <div class="text-center mt-3 text-lg fs-4">
                                        <p class='text-gray-600'>Ingat akun? <a href="{{ route('login') }}" class="font-bold">Login</a>.</p>
                                    </div>
                                </form>
                            </div>
                        </div>
